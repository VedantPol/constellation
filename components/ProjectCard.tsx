  ...
  return (
    ...
    >
      ...
      <div className="relative">
        ...
        <h3
          className={`font-heading font-semibold text-star ${
      ...
      <div className="relative mt-6 flex items-center gap-3">
        ...
        <a
          ...
          className="inline-flex cursor-pointer items-center gap-1.5 rounded-lg border border-white/10 px-3 py-2 text-sm text-slate-200 transition-colors duration-200 hover:border-white/30 hover:text-star focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-white/40"
        >
